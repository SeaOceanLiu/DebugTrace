...
bool DebugTrace::Initial(const char *pTitle)
{
    ...
    switch(enmRunningBitSize)
    {
        case RBS_x86:
            ...
            m_pfDestroyDebugForm = (void (*)(void))GetProcAddress(hDebugDllInst, "_DestroyDebugForm");
        ...
        case RBS_x64:
            ...
            m_pfDestroyDebugForm = (void (*)(void))GetProcAddress(hDebugDllInst, "DestroyDebugForm");
    ...
    if(hDebugDllInst != nullptr && m_pfCreateDebugForm != nullptr
        && m_pfDestroyDebugForm != nullptr && m_pfCloseDebugForm != nullptr
